...
| Decrease transitions | 30 |
| Decrease ratio | 52.6% |
| Flagged movement pattern groups | 2 |

## Movement Pattern Health Flags

| Severity | Movement Pattern | Exercises | Flagged | Inc | Hold | Dec | Decrease ratio | Worst member | Worst drop |
|---|---|---|---|---|---|---|---|---|---|
| high | vertical_push | 3 | 1 | 1 | 1 | 4 | 67% | Overhead Press | 40% |
| high | horizontal_pull | 1 | 1 | 1 | 0 | 2 | 67% | Dumbbell Curl | 30% |
...
| Decrease transitions | 30 |
| Decrease ratio | 52.6% |
| Flagged primary muscle groups | 2 |

## Primary Muscle Health Flags

| Severity | Primary Muscle | Exercises | Flagged | Inc | Hold | Dec | Decrease ratio | Worst member | Worst drop |
|---|---|---|---|---|---|---|---|---|---|
| high | glutes | 3 | 1 | 2 | 0 | 4 | 67% | Cable Pull-Through | 42% |
| high | shoulders | 3 | 1 | 1 | 1 | 4 | 67% | Overhead Press | 40% |
