...
| Severity | Movement Pattern | Exercises | Flagged | Flagged % | Inc | Hold | Dec | Decrease ratio | Worst member | Worst drop |
|---|---|---|---|---|---|---|---|---|---|---|
| high | horizontal_pull | 1 | 1 | 100% | 1 | 0 | 2 | 67% | Dumbbell Curl | 30% |
